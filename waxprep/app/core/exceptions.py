...
class SessionExpiredError(WaxPrepBaseException): pass
...
class WebhookVerificationError(WaxPrepBaseException): pass
class MessageSendError(WaxPrepBaseException): pass
class RateLimitExceededError(WaxPrepBaseException): pass
